namespace Hexaplanning.Utilities
{
    public static class Env
    {
        ...
        public static string CONNECTION_STRING => GetEnv(nameof(CONNECTION_STRING), "Host=localhost;Port=5432;Database=Hexaplanning;Username=postgres;Password=admin;");
